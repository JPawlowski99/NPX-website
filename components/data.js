...
export const reviews = [
  {
    ...
    image: "/asante.png",
    review:
      "NPX Software delivered an exceptional custom software solution that perfectly met our business needs. Their team was highly professional, efficient, and responsive throughout the entire development process. We are extremely satisfied with the results and would highly recommend their services.",
  },
  {
    id: 2,
    name: "Emily Johnson",
    ...
    image: "/ellen.jpg",
    review:
      "I hired NPX Software for mobile app development, and they exceeded my expectations. Their team displayed excellent technical expertise and attention to detail. The app they developed for us is user-friendly and visually appealing. I appreciate their dedication and commitment to delivering a high-quality product.",
  },
  {
    id: 3,
    name: "David Thompson",
  ...
  },
  {
    ...
    image: "/john.jpg",
    review:
      "Working with NPX Software on our e-commerce platform was a fantastic experience. They delivered a secure and scalable solution that has significantly boosted our online sales. Their attention to detail and ability to understand our business requirements were commendable. We highly recommend their e-commerce services.",
  },
  {
    id: 5,
    name: "Alex Turner",
    ...
    image: "/asante1.png",
    review:
      "The UI/UX design services provided by NPX Software were outstanding. They truly understood our brand identity and crafted visually stunning interfaces that are both aesthetically pleasing and intuitive. Our customers love the new look, and we've seen increased engagement as a result. Thank you, KodeCraft!",
  },
  {
    id: 6,
